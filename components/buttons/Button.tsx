...
let colorsDark: { [key: string]: string[] } = {
  gray: [
...
export function Button({
  ...
  return (
    <Link
      className={twMerge(
        'group inline-flex items-center h-9 rounded-md text-lg font-semibold whitespace-nowrap px-3 focus:outline-none focus:ring-2',
        colorClasses[0],
        darkColorClasses[0],
        className,
